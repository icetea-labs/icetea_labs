  ...
  <div class="new">
    <div v-if="exist" class="new-detail">
      ...
      <div class="new-socials">
        <a :href="`https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ficetea.io%2Fnew%2${id}`"
...
export default {
  ...
  computed: {
    latestNews() {
      if(news.length > 3)
        return news.slice(news.length - 3, news.length - 1)
      return news
    }
  },
  created() {
